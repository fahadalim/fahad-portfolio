    ...
    return (
      <>
        <li className={`${styles[socialClass]}`}>
          <a
            href="https://github.com/fahadalim"
        ...
        <li className={`${styles[socialClass]}`}>
          <a
            href="https://www.linkedin.com/in/mohammad-fahad-alim/"
            className="socialIcons"
            target="_blank"
            rel="noreferrer noopener"
        ...
        <li className={`${styles[socialClass]}`}>
          <a
            href="mailto:mohammadfahadalim@gmail.com"
            className="socialIcons"
            target="_blank"
            rel="noreferrer noopener"
        ...
        <li className={`${styles[socialClass]}`}>
          <a
            href="https://drive.google.com/file/d/1ds7L8nIP0vt72twQfxtxWbvkPUh4jlrJ/view?usp=sharing"
            className="socialIcons"
            target="_blank"
            rel="noreferrer"
